  ...
  return (
    <main className="font-serif">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mx-4 md:mx-[100px] mt-8">
        {['Chickendish', 'FruitDish', 'SeaFood', 'Pizza'].map((dish, index) => (
          <div key={index} className="text-center">
            <img src={`/images/${dish}.png`} className="mx-auto" alt={dish} />
      ...
      <div className="bg-[#fff9ef] py-8 mt-8">
        <div className="flex flex-col md:flex-row mx-4 md:mx-[100px]">
          ...
          <div className="mt-4 md:mt-0">
            <img src="/images/dishes.jpeg" className="w-full md:ml-[-60%]" alt="Special dishes" />
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mx-4 md:mx-40 mt-8">
        {[
          ...
          <div key={index} className="flex items-center">
            ...
            <img src={`/images/${offer.img}.png`} className="ml-4" alt={offer.title} />
          </div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mx-4 md:mx-40 mt-8">
        {[
          { img: 'pop', title: '55+ Restaurants' },
          { img: 'goodquality', title: 'Good Quality' },
          { img: 'discount system', title: 'Discount System' },
          { img: 'delivery', title: 'Fast Delivery' }
        ].map((service, index) => (
          <div key={index} className="text-center">
            <img src={`/images/${service.img}.png`} className="mx-auto" alt={service.title} />
      ...
      <div className="flex flex-wrap justify-center gap-4 mt-8">
        {['mitch', 'Peter', 'Benjamin', 'Adam', 'John'].map((person, index) => (
          <img key={index} src={`/images/${person}.jpeg`} className="w-24 md:w-32 lg:w-40" alt={person} />
        ))}
      </div>
      <div className="text-center mt-4">
        ...
        <div className="flex justify-center items-center mt-4">
          <img src="/images/left arrow.png" className="w-12 md:w-20" alt="Left arrow" />
          <img src="/images/rightarrow.jpeg" className="w-12 md:w-20" alt="Right arrow" />
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row items-center bg-[#fff9ef] p-4 md:p-8 mt-8">
        <div className="w-full md:w-1/2 mb-4 md:mb-0">
          <img src="/images/iphone.png" className="mx-auto md:mx-0" alt="iPhone app" />
        </div>
